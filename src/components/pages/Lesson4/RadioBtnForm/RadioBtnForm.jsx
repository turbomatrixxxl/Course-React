...
import styles from './RadioBtnForm.module.css';
...
class RadioBtnForm extends Component {
  state = {
    ...INITIAL_STATE,
  };
  ...
  handleSubmit = e => {
    ...
    const { login, email, password, gender, agreed } = this.state;

    console.log(
      `Login: ${login}, Email: ${email}, Password: ${password}, gender: ${gender}, Agreed: ${agreed}`
    );

    this.props.onSubmit({ login, email, password, gender, agreed });
